...
const OS_HINTS: Record<OsId, Record<Lang, string>> = {
  ...
  linux: {
    zh: 'AppImage / deb(Debian、Ubuntu) · x64 / ARM64',
    'zh-TW': 'AppImage / deb(Debian、Ubuntu) · x64 / ARM64',
    en: 'AppImage / deb (Debian, Ubuntu) · x64 / ARM64',
    ja: 'AppImage / deb (Debian, Ubuntu) · x64 / ARM64',
    ko: 'AppImage / deb (Debian, Ubuntu) · x64 / ARM64',
    de: 'AppImage / deb (Debian, Ubuntu) · x64 / ARM64',
    fr: 'AppImage / deb (Debian, Ubuntu) · x64 / ARM64',
...
const DOWNLOAD_DETAILS: Record<string, Record<Lang, string>> = {
  ...
  'win-x64': {
    zh: 'x64 · 安装版(.exe)',
    'zh-TW': 'x64 · 安裝版(.exe)',
    en: 'x64 · Installer (.exe)',
    ja: 'x64 · インストーラー(.exe)',
    ko: 'x64 · 설치 파일 (.exe)',
    de: 'x64 · Installer (.exe)',
    fr: 'x64 · Installateur (.exe)',
    es: 'x64 · Instalador (.exe)',
    pt: 'x64 · Instalador (.exe)',
    ru: 'x64 · Установщик (.exe)',
  },
  'win-x64-portable': {
    zh: 'x64 · 便携版(单文件 .exe,免安装)',
    'zh-TW': 'x64 · 可攜版(單一 .exe,免安裝)',
    en: 'x64 · Portable (single .exe, no install)',
    ja: 'x64 · ポータブル(単一 .exe・インストール不要)',
    ko: 'x64 · 포터블 (단일 .exe, 설치 불필요)',
    de: 'x64 · Portable (einzelne .exe, ohne Installation)',
    fr: 'x64 · Portable (.exe unique, sans installation)',
    es: 'x64 · Portable (un solo .exe, sin instalación)',
    pt: 'x64 · Portátil (.exe único, sem instalação)',
    ru: 'x64 · Portable (один .exe, без установки)',
  },
  'win-x64-zip': {
    zh: 'x64 · ZIP(解压即用)',
    'zh-TW': 'x64 · ZIP(解壓即用)',
    en: 'x64 · ZIP (unzip and run)',
    ja: 'x64 · ZIP(解凍してすぐ実行)',
    ko: 'x64 · ZIP (압축 해제 후 실행)',
    de: 'x64 · ZIP (entpacken und starten)',
    fr: 'x64 · ZIP (décompresser et lancer)',
    es: 'x64 · ZIP (descomprimir y ejecutar)',
    pt: 'x64 · ZIP (descompactar e executar)',
    ru: 'x64 · ZIP (распаковать и запустить)',
  },
  'win-arm64': {
    zh: 'ARM64 · 安装版(.exe)',
    'zh-TW': 'ARM64 · 安裝版(.exe)',
    en: 'ARM64 · Installer (.exe)',
    ja: 'ARM64 · インストーラー(.exe)',
    ko: 'ARM64 · 설치 파일 (.exe)',
    de: 'ARM64 · Installer (.exe)',
    fr: 'ARM64 · Installateur (.exe)',
    es: 'ARM64 · Instalador (.exe)',
    pt: 'ARM64 · Instalador (.exe)',
    ru: 'ARM64 · Установщик (.exe)',
  },
  'win-arm64-portable': {
    zh: 'ARM64 · 便携版(单文件 .exe,免安装)',
    'zh-TW': 'ARM64 · 可攜版(單一 .exe,免安裝)',
    en: 'ARM64 · Portable (single .exe, no install)',
    ja: 'ARM64 · ポータブル(単一 .exe・インストール不要)',
    ko: 'ARM64 · 포터블 (단일 .exe, 설치 불필요)',
    de: 'ARM64 · Portable (einzelne .exe, ohne Installation)',
    fr: 'ARM64 · Portable (.exe unique, sans installation)',
    es: 'ARM64 · Portable (un solo .exe, sin instalación)',
    pt: 'ARM64 · Portátil (.exe único, sem instalação)',
    ru: 'ARM64 · Portable (один .exe, без установки)',
  },
  'win-arm64-zip': {
    zh: 'ARM64 · ZIP(解压即用)',
    'zh-TW': 'ARM64 · ZIP(解壓即用)',
    en: 'ARM64 · ZIP (unzip and run)',
    ja: 'ARM64 · ZIP(解凍してすぐ実行)',
    ko: 'ARM64 · ZIP (압축 해제 후 실행)',
    de: 'ARM64 · ZIP (entpacken und starten)',
    fr: 'ARM64 · ZIP (décompresser et lancer)',
    es: 'ARM64 · ZIP (descomprimir y ejecutar)',
    pt: 'ARM64 · ZIP (descompactar e executar)',
    ru: 'ARM64 · ZIP (распаковать и запустить)',
  },
  'linux-x64': {
    zh: 'x64 · AppImage(通用,免安装)',
    'zh-TW': 'x64 · AppImage(通用,免安裝)',
    en: 'x64 · AppImage (universal, no install)',
    ja: 'x64 · AppImage(汎用・インストール不要)',
    ko: 'x64 · AppImage (범용, 설치 불필요)',
    de: 'x64 · AppImage (universell, ohne Installation)',
    fr: 'x64 · AppImage (universel, sans installation)',
    es: 'x64 · AppImage (universal, sin instalación)',
    pt: 'x64 · AppImage (universal, sem instalação)',
    ru: 'x64 · AppImage (универсальный, без установки)',
  },
  'linux-arm64': {
    zh: 'ARM64 · AppImage(通用,免安装)',
    'zh-TW': 'ARM64 · AppImage(通用,免安裝)',
    en: 'ARM64 · AppImage (universal, no install)',
    ja: 'ARM64 · AppImage(汎用・インストール不要)',
    ko: 'ARM64 · AppImage (범용, 설치 불필요)',
    de: 'ARM64 · AppImage (universell, ohne Installation)',
    fr: 'ARM64 · AppImage (universel, sans installation)',
    es: 'ARM64 · AppImage (universal, sin instalación)',
    pt: 'ARM64 · AppImage (universal, sem instalação)',
    ru: 'ARM64 · AppImage (универсальный, без установки)',
  },
  'linux-x64-deb': {
    zh: 'x64 · deb(Debian / Ubuntu)',
    'zh-TW': 'x64 · deb(Debian / Ubuntu)',
    en: 'x64 · deb (Debian / Ubuntu)',
    ja: 'x64 · deb (Debian / Ubuntu)',
    ko: 'x64 · deb (Debian / Ubuntu)',
    de: 'x64 · deb (Debian / Ubuntu)',
    fr: 'x64 · deb (Debian / Ubuntu)',
    es: 'x64 · deb (Debian / Ubuntu)',
    pt: 'x64 · deb (Debian / Ubuntu)',
    ru: 'x64 · deb (Debian / Ubuntu)',
  },
  'linux-arm64-deb': {
    zh: 'ARM64 · deb(Debian / Ubuntu)',
    'zh-TW': 'ARM64 · deb(Debian / Ubuntu)',
    en: 'ARM64 · deb (Debian / Ubuntu)',
    ja: 'ARM64 · deb (Debian / Ubuntu)',
    ko: 'ARM64 · deb (Debian / Ubuntu)',
    de: 'ARM64 · deb (Debian / Ubuntu)',
    fr: 'ARM64 · deb (Debian / Ubuntu)',
    es: 'ARM64 · deb (Debian / Ubuntu)',

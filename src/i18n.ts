...
export const copy: Record<Lang, CopyBundle> = {
  zh: {
    ...
    whyItems: [
      { title: '主机 Vault', body: '成百上千台主机仍可搜索、分组、一眼找到。' },
      { title: '终端 + SFTP 同屏', body: '改配置、看日志、传文件不必在工具间来回跳。' },
      { title: 'AI 运维搭档', body: '用自然语言排查与编排，少记命令行参数。' },
      { title: '跨平台免费使用', body: 'macOS / Windows / Linux 客户端，个人与团队均可下载使用。' },
    ],
    trustItems: ['macOS', 'Windows', 'Linux', 'AI Agent', '免费下载'],
    legalPrivacy: '隐私政策',
    legalTerms: '使用条款',
  ...
  'zh-TW': {
    ...
    whyItems: [
      { title: '主機 Vault', body: '成百上千台主機仍可搜尋、分組、一眼找到。' },
      { title: '終端 + SFTP 同屏', body: '改設定、看日誌、傳檔不必在工具間來回跳。' },
      { title: 'AI 維運搭檔', body: '用自然語言排查與編排，少記命令列參數。' },
      { title: '跨平台免費使用', body: 'macOS / Windows / Linux 用戶端，個人與團隊均可下載使用。' },
    ],
    trustItems: ['macOS', 'Windows', 'Linux', 'AI Agent', '免費下載'],
    legalPrivacy: '隱私權政策',
    legalTerms: '使用條款',
  ...
  en: {
    ...
    whyItems: [
      { title: 'Host Vault', body: 'Search and group hundreds of hosts without losing your place.' },
      { title: 'Shell + SFTP together', body: 'Edit configs, watch logs, and move files without switching apps.' },
      { title: 'AI ops partner', body: 'Diagnose and orchestrate in natural language instead of memorizing flags.' },
      { title: 'Free, cross-platform', body: 'macOS, Windows, and Linux clients — download and run.' },
    ],
    trustItems: ['macOS', 'Windows', 'Linux', 'AI Agent', 'Free download'],
  ...
  ja: {
    ...
    whyItems: [
      { title: 'ホスト Vault', body: '数百台でも検索・グループ化で迷いません。' },
      { title: 'シェル + SFTP 一体', body: '設定変更・ログ確認・転送をアプリを切り替えずに。' },
      { title: 'AI 運用パートナー', body: '自然言語で診断と編成。フラグ暗記から解放。' },
      { title: '無料・クロスプラットフォーム', body: 'macOS / Windows / Linux クライアントを提供。' },
    ],
    trustItems: ['macOS', 'Windows', 'Linux', 'AI Agent', '無料'],
    legalPrivacy: 'プライバシー',
    legalTerms: '利用規約',
  ...
  ko: {
    ...
    whyItems: [
      { title: '호스트 Vault', body: '수백 대도 검색·그룹화로 바로 찾습니다.' },
      { title: '셸 + SFTP 통합', body: '설정, 로그, 전송을 앱 전환 없이 처리합니다.' },
      { title: 'AI 운영 파트너', body: '자연어로 진단·오케스트레이션. 플래그 암기 불필요.' },
      { title: '무료·크로스 플랫폼', body: 'macOS / Windows / Linux 클라이언트 제공.' },
    ],
    trustItems: ['macOS', 'Windows', 'Linux', 'AI Agent', '무료'],
    legalPrivacy: '개인정보',
    legalTerms: '이용약관',
  ...
  de: {
    ...
    whyItems: [
      { title: 'Host-Vault', body: 'Hunderte Hosts suchen und gruppieren, ohne den Überblick zu verlieren.' },
      { title: 'Shell + SFTP zusammen', body: 'Configs, Logs und Transfers ohne App-Wechsel.' },
      { title: 'KI-Ops-Partner', body: 'Diagnose und Orchestrierung in natürlicher Sprache.' },
      { title: 'Kostenlos, plattformübergreifend', body: 'Clients für macOS, Windows und Linux.' },
    ],
    trustItems: ['macOS', 'Windows', 'Linux', 'AI Agent', 'Kostenlos'],
  ...
  fr: {
    ...
    whyItems: [
      { title: 'Coffre d’hôtes', body: 'Recherchez et regroupez des centaines d’hôtes sans vous perdre.' },
      { title: 'Shell + SFTP ensemble', body: 'Configs, logs et transferts sans changer d’app.' },
      { title: 'Partenaire ops IA', body: 'Diagnostiquez et orchestrez en langage naturel.' },
      { title: 'Gratuit, multiplateforme', body: 'Clients macOS, Windows et Linux.' },
    ],
    trustItems: ['macOS', 'Windows', 'Linux', 'AI Agent', 'Gratuit'],
  ...
  es: {
    ...
    whyItems: [
      { title: 'Vault de hosts', body: 'Busca y agrupa cientos de hosts sin perderte.' },
      { title: 'Shell + SFTP juntos', body: 'Configs, logs y transferencias sin cambiar de app.' },
      { title: 'Socio de ops con IA', body: 'Diagnostica y orquesta en lenguaje natural.' },
      { title: 'Gratis y multiplataforma', body: 'Clientes para macOS, Windows y Linux.' },
    ],
    trustItems: ['macOS', 'Windows', 'Linux', 'AI Agent', 'Gratis'],
  ...
  pt: {
    ...
    whyItems: [
      { title: 'Vault de hosts', body: 'Pesquise e agrupe centenas de hosts sem se perder.' },
      { title: 'Shell + SFTP juntos', body: 'Configs, logs e transferências sem trocar de app.' },
      { title: 'Parceiro de ops com IA', body: 'Diagnostique e orquestre em linguagem natural.' },
      { title: 'Grátis e multiplataforma', body: 'Clientes para macOS, Windows e Linux.' },
    ],
    trustItems: ['macOS', 'Windows', 'Linux', 'AI Agent', 'Grátis'],
  ...
  ru: {
    ...
    whyItems: [
      { title: 'Хранилище хостов', body: 'Ищите и группируйте сотни хостов без путаницы.' },
      { title: 'Shell + SFTP вместе', body: 'Конфиги, логи и передачи без смены приложений.' },
      { title: 'ИИ-партнёр для ops', body: 'Диагностика и оркестрация на естественном языке.' },
      { title: 'Бесплатно, кроссплатформенно', body: 'Клиенты для macOS, Windows и Linux.' },
    ],
    trustItems: ['macOS', 'Windows', 'Linux', 'AI Agent', 'Бесплатно'],

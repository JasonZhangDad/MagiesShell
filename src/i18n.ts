...
export type CopyBundle = {
  ...
  showcaseLead: string
  productHostTitle: string
  productHostDesc: string
  productTermTitle: string
  productTermDesc: string
  productThemeTitle: string
  productThemeDesc: string
  footerSeries: string
  navFeatures: string
  navPlatform: string
  navAgent: string
...
export const copy: Record<Lang, CopyBundle> = {
  zh: {
    ...
    headline: '掌控服务器，从未如此优雅',
    sub: 'MagiesTerminal 让远程连接、文件管理、命令执行变得前所未有的简单与安全。专为开发者和运维团队打造的现代化智能终端管理平台。',
    ctaDownload: '立即下载',
    ctaStart: '开始使用',
    ctaDemo: '查看演示',
    ctaEnter: '立即下载',
    ...
    navDocs: '更新日志',
    navAbout: '关于',
    showcaseTitle: '强大 · 优雅 · 连接无限',
    showcaseLead: '现代化的终端管理体验，助你轻松驾驭每一台服务器',
    productHostTitle: '主机管理',
    productHostDesc: '可视化管理 · 一键连接 · 高效运维',
    productTermTitle: '实时终端',
    productTermDesc: '流畅的命令行体验 · 专业的开发环境',
    productThemeTitle: '个性主题',
    productThemeDesc: '丰富的主题选择 · 打造专属风格',
    footerSeries: 'MAGIES · GALAXY SERIES',
    navFeatures: '特性',
    navPlatform: '可靠',
    navAgent: 'Agent',
    navDownload: '下载',
    galleryAlt1: 'MagiesTerminal 主机管理界面',
    galleryAlt2: 'MagiesTerminal 实时终端界面',
    galleryAlt3: 'MagiesTerminal 个性主题设置界面',
    ...
    whyItems: [
      ...
      { title: 'AI 运维搭档', body: '自然语言排查与编排，可接入主流模型与Agent。' },
      { title: '多协议 · 跨平台', body: 'SSH / Mosh / Telnet / 串口；macOS · Windows · Linux 免费使用。' },
    ],
    trustItems: ['安全连接', '多协议支持', '实时监控', '团队协作', 'AI 辅助'],
    legalPrivacy: '隐私政策',
    legalTerms: '使用条款',
    ...
    agentLead:
      '内置 AI 搭档理解你的环境，可接入主流模型与Agent；执行命令、诊断问题，并跨多台主机协同操作。',
    agentPoints: [
  ...
  'zh-TW': {
    ...
    headline: '掌控伺服器，從未如此優雅',
    sub: 'MagiesTerminal 讓遠端連線、檔案管理、命令執行變得前所未有的簡單與安全。專為開發者與維運團隊打造的現代化終端管理平台。',
    ctaDownload: '立即下載',
    ctaStart: '開始使用',
    ctaDemo: '查看演示',
    ctaEnter: '立即下載',
    ...
    navDocs: '更新日誌',
    navAbout: '關於',
    showcaseTitle: '強大 · 優雅 · 連線無限',
    showcaseLead: '現代化的終端管理體驗，助你輕鬆駕馭每一台伺服器',
    productHostTitle: '主機管理',
    productHostDesc: '可視化管理 · 一鍵連線 · 高效維運',
    productTermTitle: '即時終端',
    productTermDesc: '流暢的命令列體驗 · 專業的開發環境',
    productThemeTitle: '個性主題',
    productThemeDesc: '豐富的主題選擇 · 打造專屬風格',
    footerSeries: 'MAGIES · GALAXY SERIES',
    navFeatures: '特性',
    navPlatform: '可靠',
    navAgent: 'Agent',
    navDownload: '下載',
    galleryAlt1: 'MagiesTerminal 主機管理介面',
    galleryAlt2: 'MagiesTerminal 即時終端介面',
    galleryAlt3: 'MagiesTerminal 個性主題設定介面',
    ...
    whyItems: [
      ...
      { title: 'AI 維運搭檔', body: '自然語言排查與編排，可接入主流模型與Agent。' },
      { title: '多協定 · 跨平台', body: 'SSH / Mosh / Telnet / 序列埠；macOS · Windows · Linux 免費使用。' },
    ],
    trustItems: ['安全連線', '多協議支援', '即時監控', '團隊協作', 'AI 輔助'],
    legalPrivacy: '隱私權政策',
    legalTerms: '使用條款',
    ...
    agentLead:
      '內建 AI 夥伴理解你的環境，可接入主流模型與Agent；執行命令、診斷問題，並跨多台主機協同操作。',
    agentPoints: [
  ...
  en: {
    ...
    headline: 'Command your servers, elegantly',
    sub: 'MagiesTerminal makes remote access, file management, and command execution simpler and safer than ever. A modern terminal workspace built for developers and ops teams.',
    ctaDownload: 'Download',
    ctaStart: 'Get started',
    ctaDemo: 'Watch demo',
    ctaEnter: 'Download now',
    navHome: 'Home',
    navProduct: 'Product',
    navPricing: 'Download',
    navDocs: 'Changelog',
    navAbout: 'About',
    showcaseTitle: 'Powerful · Elegant · Unlimited connections',
    showcaseLead: 'A modern terminal experience that helps you master every server with ease',
    productHostTitle: 'Host management',
    productHostDesc: 'Visual management · One-click connect · Efficient ops',
    productTermTitle: 'Live terminal',
    productTermDesc: 'Fluid CLI experience · Professional environment',
    productThemeTitle: 'Custom themes',
    productThemeDesc: 'Rich theme library · Make it yours',
    footerSeries: 'MAGIES · GALAXY SERIES',
    navFeatures: 'Features',
    navPlatform: 'Reliable',
    navAgent: 'Agent',
    navDownload: 'Download',
    galleryAlt1: 'MagiesTerminal host management UI',
    galleryAlt2: 'MagiesTerminal live terminal UI',
    galleryAlt3: 'MagiesTerminal theme settings UI',
    ...
    whyItems: [
      ...
      { title: 'AI ops partner', body: 'Diagnose and orchestrate in natural language; plug in major models or Agent.' },
      { title: 'Multi-protocol · free', body: 'SSH / Mosh / Telnet / serial on macOS, Windows, and Linux — free to download.' },
    ],
    trustItems: ['Secure connections', 'Multi-protocol', 'Live monitoring', 'Team collab', 'AI assist'],
    ...
    agentLead:
      'A built-in AI partner that understands your environment, works with major models and Agent, runs commands, diagnoses issues, and coordinates across hosts.',
    agentPoints: [
  ...
  ja: {
    ...
    headline: 'サーバー操作を、かつてない優雅さで',
    sub: 'MagiesTerminal はリモート接続・ファイル管理・コマンド実行を、かつてないほどシンプルかつ安全に。開発者と運用チームのためのモダンなターミナル管理プラットフォーム。',
    ctaDownload: 'ダウンロード',
    ctaStart: 'はじめる',
    ctaDemo: 'デモを見る',
    ctaEnter: '今すぐダウンロード',
    ...
    navDocs: '更新履歴',
    navAbout: 'について',
    showcaseTitle: '強力 · 優雅 · 無限の接続',
    showcaseLead: 'モダンなターミナル管理体験で、すべてのサーバーを自在に操る',
    productHostTitle: 'ホスト管理',
    productHostDesc: '可視化管理 · ワンクリック接続 · 効率的な運用',
    productTermTitle: 'リアルタイム端末',
    productTermDesc: '滑らかな CLI · プロ向け開発環境',
    productThemeTitle: 'カスタムテーマ',
    productThemeDesc: '豊富なテーマ · 自分だけのスタイル',
    footerSeries: 'MAGIES · GALAXY SERIES',
    navFeatures: '機能',
    navPlatform: '信頼性',
    navAgent: 'Agent',
    navDownload: 'ダウンロード',
    galleryAlt1: 'MagiesTerminal ホスト管理画面',
    galleryAlt2: 'MagiesTerminal リアルタイム端末画面',
    galleryAlt3: 'MagiesTerminal テーマ設定画面',
    ...
    whyItems: [
      ...
      { title: 'AI 運用パートナー', body: '自然言語で診断と編成。主要モデルや Agent に接続可能。' },
      { title: '多プロトコル · 無料', body: 'SSH / Mosh / Telnet / シリアル。macOS · Windows · Linux で無料。' },
    ],
    trustItems: ['安全な接続', 'マルチプロトコル', 'リアルタイム監視', 'チーム協業', 'AI 支援'],
    legalPrivacy: 'プライバシー',
    legalTerms: '利用規約',
    ...
    agentLead:
      '環境を理解する AI パートナーが、主要モデルや Agent と連携し、コマンド実行・診断・複数ホスト連携を支援します。',
    agentPoints: [
  ...
  ko: {
    ...
    headline: '서버를 우아하게 장악하다',
    sub: 'MagiesTerminal은 원격 연결, 파일 관리, 명령 실행을 그 어느 때보다 간단하고 안전하게 만듭니다. 개발자와 운영 팀을 위한 현대적인 터미널 관리 플랫폼.',
    ctaDownload: '다운로드',
    ctaStart: '시작하기',
    ctaDemo: '데모 보기',
    ctaEnter: '바로 다운로드',
    ...
    navDocs: '업데이트 로그',
    navAbout: '소개',
    showcaseTitle: '강력 · 우아 · 무한 연결',
    showcaseLead: '현대적인 터미널 관리 경험으로 모든 서버를 손쉽게',
    productHostTitle: '호스트 관리',
    productHostDesc: '시각화 관리 · 원클릭 연결 · 효율적 운영',
    productTermTitle: '실시간 터미널',
    productTermDesc: '부드러운 CLI · 전문 개발 환경',
    productThemeTitle: '개성 테마',
    productThemeDesc: '풍부한 테마 · 나만의 스타일',
    footerSeries: 'MAGIES · GALAXY SERIES',
    navFeatures: '기능',
    navPlatform: '안정성',
    navAgent: 'Agent',
    navDownload: '다운로드',
    galleryAlt1: 'MagiesTerminal 호스트 관리 화면',
    galleryAlt2: 'MagiesTerminal 실시간 터미널 화면',
    galleryAlt3: 'MagiesTerminal 테마 설정 화면',
    ...
    whyItems: [
      ...
      { title: 'AI 운영 파트너', body: '자연어로 진단·오케스트레이션. 주요 모델 또는 Agent 연동.' },
      { title: '다중 프로토콜 · 무료', body: 'SSH / Mosh / Telnet / 시리얼. macOS · Windows · Linux 무료.' },
    ],
    trustItems: ['안전한 연결', '다중 프로토콜', '실시간 모니터링', '팀 협업', 'AI 보조'],
    legalPrivacy: '개인정보',
    legalTerms: '이용약관',
    ...
    agentLead:
      '환경을 이해하는 AI 파트너가 주요 모델과 Agent와 함께 명령 실행, 진단, 다중 호스트 협업을 돕습니다.',
    agentPoints: [
  ...
  de: {
    ...
    headline: 'Server steuern – so elegant wie nie',
    sub: 'MagiesTerminal macht Remote-Verbindungen, Dateiverwaltung und Befehlsausführung einfacher und sicherer denn je. Eine moderne Terminal-Plattform für Entwickler und Ops-Teams.',
    ctaDownload: 'Herunterladen',
    ctaStart: 'Loslegen',
    ctaDemo: 'Demo ansehen',
    ctaEnter: 'Jetzt laden',
    navHome: 'Start',
    navProduct: 'Produkt',
    navPricing: 'Download',
    navDocs: 'Changelog',
    navAbout: 'Über uns',
    showcaseTitle: 'Stark · Elegant · Grenzenlos verbunden',
    showcaseLead: 'Modernes Terminal-Management – meistern Sie jeden Server mit Leichtigkeit',
    productHostTitle: 'Host-Verwaltung',
    productHostDesc: 'Visuell · Ein-Klick-Verbindung · Effizienter Betrieb',
    productTermTitle: 'Live-Terminal',
    productTermDesc: 'Flüssige CLI · Professionelle Umgebung',
    productThemeTitle: 'Eigene Themes',
    productThemeDesc: 'Reiche Themen · Ihr eigener Stil',
    footerSeries: 'MAGIES · GALAXY SERIES',
    navFeatures: 'Features',
    navPlatform: 'Zuverlässig',
    navAgent: 'Agent',
    navDownload: 'Download',
    galleryAlt1: 'MagiesTerminal Host-Verwaltung',
    galleryAlt2: 'MagiesTerminal Live-Terminal',
    galleryAlt3: 'MagiesTerminal Theme-Einstellungen',
    galleryAlt4: 'MagiesTerminal Host-Vault-Screenshot',
    ...
    whyItems: [
      ...
      { title: 'KI-Ops-Partner', body: 'Diagnose und Orchestrierung in natürlicher Sprache; große Modelle oder Agent.' },
      { title: 'Multi-Protokoll · kostenlos', body: 'SSH / Mosh / Telnet / seriell auf macOS, Windows und Linux.' },
    ],
    trustItems: ['Sichere Verbindungen', 'Multi-Protokoll', 'Live-Monitoring', 'Team-Kollaboration', 'KI-Assistenz'],
    ...
    agentLead:
      'Ein integrierter KI-Partner versteht Ihre Umgebung, arbeitet mit großen Modellen und Agent, führt Befehle aus, diagnostiziert und orchestriert Hosts.',
    agentPoints: [
  ...
  fr: {
    ...
    headline: 'Maîtrisez vos serveurs, avec élégance',
    sub: 'MagiesTerminal rend les connexions distantes, la gestion de fichiers et l\'exécution de commandes plus simples et sûres que jamais. Une plateforme terminale moderne pour développeurs et équipes ops.',
    ctaDownload: 'Télécharger',
    ctaStart: 'Commencer',
    ctaDemo: 'Voir la démo',
    ctaEnter: 'Télécharger',
    navHome: 'Accueil',
    navProduct: 'Produit',
    navPricing: 'Télécharger',
    navDocs: 'Journal',
    navAbout: 'À propos',
    showcaseTitle: 'Puissant · Élégant · Connexions illimitées',
    showcaseLead: 'Une expérience de gestion de terminaux moderne pour maîtriser chaque serveur',
    productHostTitle: 'Gestion des hôtes',
    productHostDesc: 'Gestion visuelle · Connexion en un clic · Ops efficaces',
    productTermTitle: 'Terminal en direct',
    productTermDesc: 'CLI fluide · Environnement pro',
    productThemeTitle: 'Thèmes personnalisés',
    productThemeDesc: 'Riche bibliothèque · Votre style',
    footerSeries: 'MAGIES · GALAXY SERIES',
    navFeatures: 'Fonctionnalités',
    navPlatform: 'Fiable',
    navAgent: 'Agent',
    navDownload: 'Télécharger',
    galleryAlt1: 'Interface de gestion des hôtes MagiesTerminal',
    galleryAlt2: 'Interface terminal en direct MagiesTerminal',
    galleryAlt3: 'Interface des thèmes MagiesTerminal',
    ...
    whyItems: [
      ...
      { title: 'Partenaire ops IA', body: 'Diagnostiquez et orchestrez en langage naturel ; modèles majeurs ou Agent.' },
      { title: 'Multi-protocole · gratuit', body: 'SSH / Mosh / Telnet / série sur macOS, Windows et Linux.' },
    ],
    trustItems: ['Connexions sécurisées', 'Multi-protocoles', 'Supervision temps réel', 'Collaboration', 'Assistance IA'],
    ...
    agentLead:
      'Un partenaire IA intégré comprend votre environnement, s’appuie sur les grands modèles et Agent, exécute des commandes, diagnostique et coordonne les hôtes.',
    agentPoints: [
  ...
  es: {
    ...
    headline: 'Domina tus servidores, con elegancia',
    sub: 'MagiesTerminal hace que la conexión remota, la gestión de archivos y la ejecución de comandos sean más simples y seguras que nunca. Una plataforma de terminal moderna para desarrolladores y equipos de ops.',
    ctaDownload: 'Descargar',
    ctaStart: 'Empezar',
    ctaDemo: 'Ver demo',
    ctaEnter: 'Descargar ya',
    navHome: 'Inicio',
    navProduct: 'Producto',
    navPricing: 'Descargar',
    navDocs: 'Registro',
    navAbout: 'Acerca de',
    showcaseTitle: 'Potente · Elegante · Conexiones ilimitadas',
    showcaseLead: 'Una experiencia moderna de gestión de terminales para dominar cada servidor',
    productHostTitle: 'Gestión de hosts',
    productHostDesc: 'Gestión visual · Conexión en un clic · Ops eficientes',
    productTermTitle: 'Terminal en vivo',
    productTermDesc: 'CLI fluida · Entorno profesional',
    productThemeTitle: 'Temas personalizados',
    productThemeDesc: 'Biblioteca rica · Tu propio estilo',
    footerSeries: 'MAGIES · GALAXY SERIES',
    navFeatures: 'Funciones',
    navPlatform: 'Fiable',
    navAgent: 'Agent',
    navDownload: 'Descargar',
    galleryAlt1: 'Interfaz de gestión de hosts de MagiesTerminal',
    galleryAlt2: 'Interfaz de terminal en vivo de MagiesTerminal',
    galleryAlt3: 'Interfaz de temas de MagiesTerminal',
    ...
    whyItems: [
      ...
      { title: 'Socio de ops con IA', body: 'Diagnostica y orquesta en lenguaje natural; modelos principales o Agent.' },
      { title: 'Multiprotocolo · gratis', body: 'SSH / Mosh / Telnet / serie en macOS, Windows y Linux.' },
    ],
    trustItems: ['Conexiones seguras', 'Multiprotocolo', 'Monitor en vivo', 'Colaboración', 'Asistencia IA'],
    ...
    agentLead:
      'Un socio de IA integrado entiende tu entorno, trabaja con modelos principales y Agent, ejecuta comandos, diagnostica y coordina hosts.',
    agentPoints: [
  ...
  pt: {
    ...
    headline: 'Domine seus servidores, com elegância',
    sub: 'O MagiesTerminal torna conexões remotas, gestão de arquivos e execução de comandos mais simples e seguros do que nunca. Uma plataforma de terminal moderna para desenvolvedores e equipes de ops.',
    ctaDownload: 'Baixar',
    ctaStart: 'Começar',
    ctaDemo: 'Ver demo',
    ctaEnter: 'Baixar agora',
    navHome: 'Início',
    navProduct: 'Produto',
    navPricing: 'Baixar',
    navDocs: 'Changelog',
    navAbout: 'Sobre',
    showcaseTitle: 'Poderoso · Elegante · Conexões ilimitadas',
    showcaseLead: 'Uma experiência moderna de gestão de terminais para dominar cada servidor',
    productHostTitle: 'Gestão de hosts',
    productHostDesc: 'Gestão visual · Conexão em um clique · Ops eficientes',
    productTermTitle: 'Terminal ao vivo',
    productTermDesc: 'CLI fluida · Ambiente profissional',
    productThemeTitle: 'Temas personalizados',
    productThemeDesc: 'Biblioteca rica · Seu estilo',
    footerSeries: 'MAGIES · GALAXY SERIES',
    navFeatures: 'Recursos',
    navPlatform: 'Confiável',
    navAgent: 'Agent',
    navDownload: 'Baixar',
    galleryAlt1: 'Interface de gestão de hosts do MagiesTerminal',
    galleryAlt2: 'Interface de terminal ao vivo do MagiesTerminal',
    galleryAlt3: 'Interface de temas do MagiesTerminal',
    ...
    whyItems: [
      ...
      { title: 'Parceiro de ops com IA', body: 'Diagnostique e orquestre em linguagem natural; modelos principais ou Agent.' },
      { title: 'Multiprotocolo · grátis', body: 'SSH / Mosh / Telnet / serial no macOS, Windows e Linux.' },
    ],
    trustItems: ['Conexões seguras', 'Multiprotocolo', 'Monitoramento ao vivo', 'Colaboração', 'Assistência IA'],
    ...
    agentLead:
      'Um parceiro de IA integrado entende seu ambiente, trabalha com modelos principais e Agent, executa comandos, diagnostica e coordena hosts.',
    agentPoints: [
  ...
  ru: {
    ...
    headline: 'Управляйте серверами — элегантно как никогда',
    sub: 'MagiesTerminal делает удалённый доступ, работу с файлами и выполнение более простыми и безопасными. Современная платформа терминала для разработчиков и ops-команд.',
    ctaDownload: 'Скачать',
    ctaStart: 'Начать',
    ...
    navDocs: 'История',
    navAbout: 'О нас',
    showcaseTitle: 'Мощно · Элегантно · Безграничные подключения',
    showcaseLead: 'Современный опыт управления терминалами — легко освоить каждый сервер',
    productHostTitle: 'Управление хостами',
    productHostDesc: 'Визуальное управление · Подключение в один клик · Эффективные ops',
    productTermTitle: 'Живой терминал',
    productTermDesc: 'Плавный CLI · Профессиональная среда',
    productThemeTitle: 'Свои темы',
    productThemeDesc: 'Богатая библиотека · Ваш стиль',
    footerSeries: 'MAGIES · GALAXY SERIES',
    navFeatures: 'Возможности',
    navPlatform: 'Надёжность',
    navAgent: 'Agent',
    navDownload: 'Скачать',
    galleryAlt1: 'Интерфейс управления хостами MagiesTerminal',
    galleryAlt2: 'Интерфейс живого терминала MagiesTerminal',
    galleryAlt3: 'Интерфейс тем MagiesTerminal',
    ...
    whyItems: [
      ...
      { title: 'ИИ-партнёр для ops', body: 'Диагностика и оркестрация на естественном языке; крупные модели или Agent.' },
      { title: 'Мультипротокол · бесплатно', body: 'SSH / Mosh / Telnet / serial на macOS, Windows и Linux.' },
    ],
    trustItems: ['Безопасные подключения', 'Мультипротокол', 'Мониторинг в реальном времени', 'Командная работа', 'ИИ-помощь'],
    ...
    agentLead:
      'Встроенный ИИ-партнёр понимает окружение, работает с крупными моделями и Agent, выполняет команды, диагностирует и координирует хосты.',
    agentPoints: [
